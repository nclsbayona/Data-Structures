...
int main()
{
    ...
    myGraph2.agregarArista(1, 5, 0, 1);
    myGraph2.agregarArista(1, 9, 0, 1);
    myGraph2.agregarArista(2, 4, 0, 1);
    myGraph2.agregarArista(2, 7, 0, 1);
    myGraph2.agregarArista(3, 1, 0, 1);
    myGraph2.agregarArista(3, 9, 0, 1);
    myGraph2.agregarArista(4, 8, 0, 1);
    myGraph2.agregarArista(4, 5, 0, 1);
    myGraph2.agregarArista(4, 7, 0, 1);
    myGraph2.agregarArista(5, 6, 0, 1);
    myGraph2.agregarArista(5, 9, 0, 1);
    myGraph2.agregarArista(6, 2, 0, 1);
    myGraph2.agregarArista(6, 3, 0, 1);
    myGraph2.agregarArista(7, 5, 0, 1);
    myGraph2.agregarArista(7, 6, 0, 1);
    myGraph2.agregarArista(8, 2, 0, 1);
    myGraph2.agregarArista(9, 6, 0, 1);
